...
<Frame>
  <img
    src="/images/cli/chat-session.png"
    alt="Rubix CLI session showing the user asking 'How is my infra doing?', the agent's thought 'Evaluating Infrastructure Status', an action calling get_observability_stats(), and a response stating the environment has 67 active issues and 68 total insights."
  />
