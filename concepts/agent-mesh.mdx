...
**In your cluster:** Two lightweight components run locally — the **RubixKube Observer** and the **Kubernetes MCP Server**. Combined, they typically use around 255MB RAM and minimal CPU (under 10 millicores during normal operation).
