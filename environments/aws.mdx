...
<Frame>
  <img
    src="/images/platform/connect-aws.png"
    alt="Connect Amazon AWS dialog with a one-line installer command, the API key input, the list of what will be monitored (EC2, ECS and Lambda, RDS, CloudWatch), and a system requirements callout."
  />
