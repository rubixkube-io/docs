...
<Frame>
  <img
    src="/images/platform/connect-gcp.png"
    alt="Connect Google Cloud dialog with a one-line installer command, the API key input, the list of what will be monitored (Compute Engine, GKE and Cloud Run, Cloud SQL, Cloud Monitoring), and a system requirements callout."
  />
