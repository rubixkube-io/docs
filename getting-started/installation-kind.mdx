...
**What's happening?**
- KIND creates a Kubernetes cluster running inside Docker containers
...
<AccordionGroup>
  ...
  <Accordion title=" What if STATUS shows 'CrashLoopBackOff'?">
    ...
    **Solution:**
    1. Double-check you used YOUR api key from the dashboard
...
<AccordionGroup>
  <Accordion title="Docker daemon not running">
    ...
    **Solution:**
    - **macOS/Windows:** Open Docker Desktop app and wait for it to start
  ...
  <Accordion title="kubectl: command not found">
    ...
    **Solution:**
    - Kubectl is not in your system PATH
  ...
  <Accordion title="Port already in use">
    ...
    **Solution:**
    Another process is using Kubernetes default ports.
