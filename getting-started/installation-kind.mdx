...
### Option 2: Download from Docker Website
    ...
    2. Click**"Download for Mac"** 3. Choose your Mac type:
...
### Step 2: Download Docker Desktop
    ...
    2. Click**"Download for Windows"** 3. Run the installer (`Docker Desktop Installer.exe`)
...
**Create cluster with custom configuration:**```bash
cat <<RUBIX_EOF | kind create cluster --name rubixkube-local --config=-
kind: Cluster
...
### Check these:
    1.**Verify API key is correct**    ```bash
