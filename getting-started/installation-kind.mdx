...
### Step 3: Launch Docker Desktop
    ...
    <Warning>
**Virtualization Required:**Docker Desktop requires hardware virtualization. Enable VT-x/AMD-V in your BIOS if you see errors.
    </Warning>
  </Tab>
...
### For Fedora/RHEL/CentOS:
    ...
    <Tip>
**Permission Denied?**Make sure you logged out and back in after adding your user to the docker group.
    </Tip>
  </Tab>
</Tabs>
