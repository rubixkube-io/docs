...
RubixKube combines **AI agents, deep infrastructure knowledge, and automated remediation** to create a self-healing reliability layer across Kubernetes, AWS, GCP, and VM environments:

<CardGroup cols={2}>
  <Card title="Observes Like an SRE" icon="eye">
    Continuously monitors your environments with service and dependency context
  </Card>
  ...
  <Card title="Prevents Incidents" icon="shield">
    Detects risky changes and drift before they cause outages
  </Card>
...
<Steps>
  ...
  <Step title="Choose Your Environment">
    Pick the quick start that matches where you want to observe and troubleshoot

    <CardGroup cols={2}>
      <Card
        title="Kubernetes"
        icon="cubes"
        href="/getting-started/environment-quickstart-kubernetes"
      >
      ...
      <Card
        title="AWS"
        icon="aws"
        href="/getting-started/environment-quickstart-aws"
      >
        Account-level AWS infrastructure observation
      </Card>
      <Card
        title="GCP"
        icon="google"
        href="/getting-started/environment-quickstart-gcp"
      >
        Project-level GCP infrastructure observation
      </Card>
      <Card
        title="Generic VM"
        icon="server"
        href="/getting-started/environment-quickstart-vm"
      >
        System-level Linux VM observation
      </Card>
    </CardGroup>
  </Step>

  <Step title="Start Monitoring">
    Watch RubixKube observe your environment and detect issues
  ...
  <Step title="See It in Action">
    Run safe failure simulations and watch RubixKube diagnose and remediate

    <Card
      title="Try a Kubernetes Failure Drill"
      icon="flask"
...
<CardGroup cols={3}>
  ...
  >
    Use natural language to query your environment
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title=" Conversational Infrastructure Control" icon="message">
    Manage your environment using natural language:
    - "Why is my checkout service slow?"
    - "Show me resources with high memory usage"
...
<CardGroup cols={2}>
  <Card title="Contribute to Docs" icon="edit">
