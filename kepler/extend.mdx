...
{/* SCREENSHOT: kepler/integrations-catalog.png : state: Settings > Tools & MCP from the top: Progressive tool discovery, two configured integrations marked Enabled, the Detected on this machine row, then the catalog */}
<Frame>
  <img src="/images/kepler/integrations-catalog.png" alt="Settings > Tools & MCP in Kepler. Progressive tool discovery at the top, then Configured with two integrations marked Enabled, a Detected on this machine row counting 19 command-line tools, and the catalog below starting with RubixKube and Grafana." />
