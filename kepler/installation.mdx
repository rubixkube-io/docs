...
{/* kepler:version — the span below is the single source of truth for the displayed version. Two things refresh it: kepler-version.js in the reader's browser, and scripts/update_kepler_version.py in the repo. Keep the id and keep a real version inside it; the text between the tags is what both replace. */}

Kepler is a desktop app. Download the installer for your operating system from the [releases page](https://github.com/rubixkube-io/kepler-releases/releases/latest), open it, and sign in. The current version is **<span id="kepler-version">0.1.8-beta</span>**.
