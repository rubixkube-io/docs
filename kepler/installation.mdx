...
Kepler is a desktop app. Download the installer for your operating system from the [releases page](https://github.com/rubixkube-io/kepler-releases/releases/latest), open it, and sign in. The current version is **<span id="kepler-version">0.1.6-beta</span>**.
