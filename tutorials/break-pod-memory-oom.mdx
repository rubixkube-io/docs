...
1.**"Out of memory (OOMKilled) detected on Pod/memory-hog-demo" **  - **"Out of memory (OOMKilled) detected on Pod/memory-hog-demo"** HIGH 
   - **Status:** Active
   - **Detected:** Immediately after first OOM

2.**"Container experiencing repeated crashes in memory-hog-demo" **  - **"Container experiencing repeated crashes in memory-hog-demo"** Medium  
   - **Status:** Active
...
**Within 1-2 minutes:** - ** Within 1-2 minutes:** (OOMKilled incident marked resolved)
