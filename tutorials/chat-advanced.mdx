...
<Tip>
<strong>SRE Pro Tip:</strong> Use "URGENT" or "production" in your query - the agent understands priority and responds accordingly.
</Tip>
...
<Tip>
<strong>Platform Engineer Tip:</strong> Ask for comparisons! "Compare dev vs. prod resource usage" helps identify over-provisioning in lower environments.
</Tip>
...
**Time: 30 seconds****Result:**Confident to start the day
...
**Time: 2 minutes****Result:**Safe deployment
...
**Time: 1 minute****Result:**Sleep well, knowing it's stable
...
**Time: 3 minutes****Result:**Back to sleep
...
**Use cases:**- Pre-deployment validation
- Security audits
...
**Workflow:**    1. See incident spike in Dashboard
...
**Workflow:**    1. View RCA report in Insights
...
**Automatic:**    Agent queries historical incidents
...
<Warning>
### Current Limitations:
**Chat CANNOT (yet):**- Execute kubectl commands for you
- Apply configuration changes
- Restart pods/deployments
- Create/modify resources

**Workarounds:**- Agent provides kubectl commands → You run them
...
**Pro workflow:** 1. Press `⌘K` (wherever you are)
2. Type "chat"
3. Type query
4. Press Enter
5. Get answer
