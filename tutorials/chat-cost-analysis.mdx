---
title: 'Cost analysis with Chat'
sidebarTitle: 'Chat for cost analysis'
description: 'Analyse and reduce infrastructure cost using RubixKube Chat. Rightsizing, anomaly hunting, weekly budget reviews.'
---
