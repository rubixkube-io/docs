...
> "Based on this, **heavy-app-1** and **heavy-app-2** are the most expensive pods, as they have the highest resource requests and limits."
...
### heavy-app-1 (nginx): **SIGNIFICANTLY OVER-PROVISIONED**
- Allocated: 1 CPU, 1Gi RAM
...
### heavy-app-2 (redis): **POSSIBLY OVER-PROVISIONED**
- Allocated: 500m CPU, 2Gi RAM  
...
**Action Plan:**
- Monitor CPU/memory consumption for 24-48 hours
...
**How it works:**
- VPA monitors actual resource usage
...
| **Total** | **450m** | **768Mi** | **~$18/month** | **$35 (66%)** |
...
**What we asked:**
1. "What's my cluster cost estimate?"
...
**What agent provided:**
-  Infrastructure overview (11 pods, 1 node, etc.)
...
**Action:**
1. Deploy metrics-server: `kubectl apply -f https://github.com/kubernetes-sigs/metrics-server/releases/latest/download/components.yaml`
...
**First targets:**
1. nginx/apache pods (usually over-provisioned)
