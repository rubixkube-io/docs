...
<Frame>
  <img
    src="/images/chat/scenario1-response-complete.png"
    alt="Agent response after analyzing"
  />
</Frame>
...
**Agent does ALL of the above automatically:**
- ✅ Gets pod status
- ✅ Checks events
- ✅ Retrieves logs
...
**Agent Response:**
> "I checked the `default` namespace and found nothing. Which namespace are your applications in?"
