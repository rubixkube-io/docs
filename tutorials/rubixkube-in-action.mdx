...
**Dashboard Metrics Changed:**- **Active Insights:** 0 →** 3 **(three separate issues detected)
...
**Related Incident:**- This crash loop is**caused by**the OOMKilled
...
**RubixKube ranked issues appropriately:**- **HIGH:**OOMKilled (resource exhaustion, node impact risk)
...
**RubixKube connected related incidents:**- Recognized memory-hog-demo's crash loop is**caused by**OOMKilled
