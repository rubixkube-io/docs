...
**Click "Severity" to see options:**- **critical**- System-wide failures, immediate action
...
**Summary metrics:**- ** 2 items**- incident occurred twice
- ** 1 day ago**- last occurrence
- ** 45% confidence**- RCA confidence level
- **Status: RCA_GENERATED**- analysis state

**Progress bar:**- **Status: Complete**- investigation finished
...
**Detected:**- ** 3 days ago**- first occurrence
- Oct 4, 2025 01:58 - exact timestamp

**Last Seen:**- ** 1 day ago**- most recent occurrence
- Oct 5, 2025 12:26 - exact timestamp

**Confidence:**- ** 50%**- RCA confidence level
- Moderate confidence, review evidence

**Source:**- **observer**- detected by RubixKube Observer Agent
...
**Each recommendation includes:**- **Priority badge**(HIGH PRIORITY or MEDIUM PRIORITY with colored icon)
