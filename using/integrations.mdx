...
description: 'Connect RubixKube with Slack, PagerDuty, Linear, Notion, and your own private tools.'
---
...
<Frame>
  <img
    src="/images/platform/integrations-catalogue.png"
    alt="Integrations page with counters for total, enabled, available, and error state. Rows for Slack, RubixKube Docs, Exa, GitHub, Notion, Atlassian Rovo, Linear, PagerDuty, AWS Knowledge, DeepWiki, and Context7 with protocol and tool badges."
  />
