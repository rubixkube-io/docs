...
**Update** — Edit any field on an existing integration. Passing new credentials replaces them entirely (re-encrypted). Omit credentials to preserve existing ones.
