...
title: 'Skills'
sidebarTitle: 'Skills'
description: 'Enable system skills or create custom ones to extend the capabilities of your agents.'
---
...
<Frame>
  <img
    src="/images/platform/skills-catalogue.png"
    alt="Agent Skills page with System and Custom counters, skills catalogue on the left, and a skill open on the right showing description and agent instructions."
  />
