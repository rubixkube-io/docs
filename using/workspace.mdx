---
title: 'Team and Workspace Management'
sidebarTitle: 'Team & Workspace Management'
description: 'Invite team members, manage roles, and collaborate on reliability inside a RubixKube workspace.'
---
...
<Frame>
  <img
    src="/images/platform/team-invite.png"
    alt="Team management page with a list of current members, a Send Invitation modal open for adding a new member by email, and Members and Pending Invites tabs."
  />
